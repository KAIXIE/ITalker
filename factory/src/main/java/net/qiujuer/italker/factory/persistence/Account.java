...
public class Account {
    ...
    private static final String KEY_OTHER_TOKEN = "KEY_OTHER_TOKEN";
    ...
    public static void load(Context context) {
        ...
        otherToken = sp.getString(KEY_OTHER_TOKEN, "");
    }
    ...
    public static void saveOtherToken(String token) {
        Account.otherToken = token;
        // 获取数据持久化的SP
        SharedPreferences sp = Factory.app().getSharedPreferences(Account.class.getName(),
                Context.MODE_PRIVATE);
        // 存储数据
        sp.edit()
                .putString(KEY_OTHER_TOKEN, otherToken).apply();
    }

    public static void deleteOtherToken() {
        Account.otherToken = "";
        // 获取数据持久化的SP
        SharedPreferences sp = Factory.app().getSharedPreferences(Account.class.getName(),
                Context.MODE_PRIVATE);
        // 存储数据
        sp.edit()
                .putString(KEY_OTHER_TOKEN, "").apply();
    }
}
