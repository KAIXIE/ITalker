...
public class Network {
    ...
    public static Retrofit getOtherRetrofit() {
        if (instance.otherRetrofit != null)
            return instance.otherRetrofit;
        ...
        // 设置电脑链接
        instance.otherRetrofit = builder.baseUrl(Common.Constance.API_STUDENT_URL)
                // 设置client
                .client(client)
                // 设置Json解析器
                .addConverterFactory(GsonConverterFactory.create(Factory.getGson()))
     ...
     */
    public static RemoteService otherRemote() {
        return Network.getOtherRetrofit().create(RemoteService.class);
    }
