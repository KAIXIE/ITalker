...
import net.qiujuer.italker.factory.presenter.section.SectionDetailContract;
import net.qiujuer.italker.factory.presenter.section.SectionDetailPresenter;
 ...
 */
public class SectionDetailFragment extends PresenterFragment<SectionDetailContract.Presenter> implements SectionDetailContract.View,Html.ImageGetter {
    ...
    public static SectionDetailFragment newInstance(String detailId, String headImgPath) {
    ...
    protected void initArgs(Bundle bundle) {
        if (bundle != null) {
            mSectionId = bundle.getString(DETAIL_ID);
    ...
    protected void initData() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                mPresenter.loadSectionDetail(mSectionId);
            }
        }).start();
    }
    ...
    @Override
    public void sectionDetailLoaded(SectionDetailModel model) {
    ...
    @Override
    protected SectionDetailContract.Presenter initPresenter() {
        return new SectionDetailPresenter(this);
    }
