...
import net.qiujuer.italker.push.frags.main.BlackFragment;
import net.qiujuer.italker.push.frags.main.ContactFragment;
import net.qiujuer.italker.push.frags.main.GroupFragment;
import net.qiujuer.italker.push.frags.main.PersonFragment;
import net.qiujuer.italker.push.helper.BottomNavigationViewHelper;
...
public class MainActivity extends Activity
    ...
    protected void initWidget() {
        ...
        mNavHelper.add(R.id.action_home, new NavHelper.Tab<>(ActiveFragment.class, R.string.title_home))
                ...
                .add(R.id.action_black, new NavHelper.Tab<>(BlackFragment.class, R.string.title_black))
                .add(R.id.action_person_main, new NavHelper.Tab<>(PersonFragment.class, R.string.title_person))
    ...
    public void onTabChanged(NavHelper.Tab<Integer> newTab, NavHelper.Tab<Integer> oldTab) {
        ...
        if (Objects.equals(newTab.extra, R.string.title_person)) {
            showStudentTitle();
        }else {
            hideStudentTitle();
        }
